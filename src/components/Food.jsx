        ...
        <div className="Food_contant">
          ...
          <div className="Food_contant_item">
            ...
            <div className="Food_contant_items">
              ...
              <a href="https://aabsweets.com/products/restaurant/" className="Food_Hotel_Menu_Btn">View Menu</a>
            </div>
            <div className="Food_contant_items">
              ...
              <a href="https://kuppanna.com/" className="Food_Hotel_Menu_Btn">View Menu</a>
            </div>
            <div className="Food_contant_items">
              ...
              <a href="https://hydbiryanihouse.com/" className="Food_Hotel_Menu_Btn">View Menu</a>
            </div>
            <div className="Food_contant_items">
              ...
              <a href="https://online.kfc.co.in/menu" className="Food_Hotel_Menu_Btn">View Menu</a>
            </div>
            <div className="Food_contant_items">
              ...
              <a href="https://www.dominos.co.in/menu" className="Food_Hotel_Menu_Btn">View Menu</a>
            </div>
            <div className="Food_contant_items">
              ...
              <a href="/" className="Food_Hotel_Menu_Btn">View Menu</a>
            </div>
          </div>
        </div>
        <Footer />
