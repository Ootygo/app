      ...
      <div className="Cantant">
        <div className="Contant_1">
          ...
          <div className="kavi">
            <img
              ...
              alt="2"
            />
            <h3 className="Contant_Title">Drive</h3>
          </div>
          <div className="kavi">
            <img
              className="Contant_img"
        ...
        <div className="Contant_2">
          <div className="kavi">
            <img
              className="Contant_img"
              src="https://img1.wsimg.com/isteam/ip/ab7cd702-ceba-4c53-a312-1a0951af6c3a/blob-13191f2.png/:/cr=t:0%25,l:16.67%25,w:66.67%25,h:100%25/rs=w:365,h:365,cg:true"
              alt="4"
            />
            <h3 className="Contant_Title">Night</h3>
          </div>
          <div className="kavi">
            <img
              className="Contant_img"
